...
You can find your API key in the [SeerStack Dashboard](https://app.seerstack.app) under **Settings > Developer**.
...
<Tabs>
  ...
  <Tab title="cURL">
    ...
    # Identify a user
    curl -X POST https://api.seerstack.app/identify \
      -H "Authorization: Bearer $SEERSTACK_API_KEY" \
      -H "Content-Type: application/json" \
